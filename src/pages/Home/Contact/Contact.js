...
<div className="w-full">
    <div className="bg-gradient-to-b from-gray-800 to-gray-800 h-96"></div>
        ...
        <div className="bg-white w-full shadow rounded p-8 sm:p-12 -mt-72">
            ...
            <form action="" method="post">
                ...
                <div className="flex items-center justify-center w-full">
                    <button className="mt-9 font-semibold leading-none text-white py-4 px-10 bg-gray-800 rounded hover:bg-gray-800 focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 focus:outline-none">
                        Send message
                    </button>
                </div>
            </form>
